import {TextInput, Text, View, TouchableOpacity, StyleSheet, PermissionsAndroid,ScrollView} from 'react-native';
...
export default class Balance extends React.Component{
    ...
    getDebt = async () => {
      this.setState({ loading: true, disabled: true }, async () => {
        fetch('http://35.189.94.121/payments/getDebt/'+ this.state.userId, {
          method: 'GET',
          headers: {
   ...
   /*componentDidUpdate(prevProps){
      ...
      this.fetchData(this.props.balance)
    }*/
